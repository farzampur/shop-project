...
export interface Cart { id:number; store:number; store_name:string; customer:number|null; customer_name?:string|null; items:CartItem[]; total_before_discount:string; total_discount:string; total_price:string; subtotal_price?:string; discount_amount?:string; }
